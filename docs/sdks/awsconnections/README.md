...
async function run() {
  const result = await firehydrantTypescriptSDK.awsConnections.list({});
...
import { awsConnectionsList } from "firehydrant-typescript-sdk/funcs/awsConnectionsList.js";
...
async function run() {
  const res = await awsConnectionsList(firehydrantTypescriptSDK, {});
...
async function run() {
  const result = await firehydrantTypescriptSDK.awsConnections.get({
    id: "<id>",
  });
...
```typescript
import { FirehydrantTypescriptSDKCore } from "firehydrant-typescript-sdk/core.js";
import { awsConnectionsGet } from "firehydrant-typescript-sdk/funcs/awsConnectionsGet.js";
...
async function run() {
  const res = await awsConnectionsGet(firehydrantTypescriptSDK, {
    id: "<id>",
  });
