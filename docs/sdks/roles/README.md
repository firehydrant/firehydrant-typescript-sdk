...
<!-- UsageSnippet language="typescript" operationID="list_roles" method="get" path="/v1/roles" -->
```typescript
...
<!-- UsageSnippet language="typescript" operationID="create_role" method="post" path="/v1/roles" -->
```typescript
import { Firehydrant } from "firehydrant-typescript-sdk";
...
<!-- UsageSnippet language="typescript" operationID="get_role" method="get" path="/v1/roles/{id}" -->
```typescript
import { Firehydrant } from "firehydrant-typescript-sdk";
...
<!-- UsageSnippet language="typescript" operationID="delete_role" method="delete" path="/v1/roles/{id}" -->
```typescript
import { Firehydrant } from "firehydrant-typescript-sdk";
...
<!-- UsageSnippet language="typescript" operationID="update_role" method="patch" path="/v1/roles/{id}" -->
```typescript
import { Firehydrant } from "firehydrant-typescript-sdk";
