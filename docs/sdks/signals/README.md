...
<!-- UsageSnippet language="typescript" operationID="get_support_hours_schedule" method="get" path="/v1/teams/{team_id}/support_hours_schedule" -->
```typescript
...
async function run() {
  const result = await firehydrant.signals.getSupportHoursSchedule({
    teamId: "<id>",
  });
...
import { signalsGetSupportHoursSchedule } from "firehydrant-typescript-sdk/funcs/signalsGetSupportHoursSchedule.js";
...
async function run() {
  const res = await signalsGetSupportHoursSchedule(firehydrant, {
    teamId: "<id>",
  });
  if (res.ok) {
    ...
    console.log("signalsGetSupportHoursSchedule failed:", res.error);
  }
}
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetSupportHoursScheduleRequest](../../models/operations/getsupporthoursschedulerequest.md)                                                                         | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[components.SupportHoursScheduleEntity](../../models/components/supporthoursscheduleentity.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="delete_support_hours_schedule" method="delete" path="/v1/teams/{team_id}/support_hours_schedule" -->
```typescript
import { Firehydrant } from "firehydrant-typescript-sdk";
...
async function run() {
  await firehydrant.signals.deleteSupportHoursSchedule({
    teamId: "<id>",
  });
...
```typescript
import { FirehydrantCore } from "firehydrant-typescript-sdk/core.js";
import { signalsDeleteSupportHoursSchedule } from "firehydrant-typescript-sdk/funcs/signalsDeleteSupportHoursSchedule.js";
...
async function run() {
  const res = await signalsDeleteSupportHoursSchedule(firehydrant, {
    teamId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("signalsDeleteSupportHoursSchedule failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.DeleteSupportHoursScheduleRequest](../../models/operations/deletesupporthoursschedulerequest.md)                                                                   | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
<!-- UsageSnippet language="typescript" operationID="update_support_hours_schedule" method="patch" path="/v1/teams/{team_id}/support_hours_schedule" -->
```typescript
import { Firehydrant } from "firehydrant-typescript-sdk";
...
async function run() {
  const result = await firehydrant.signals.updateSupportHoursSchedule({
    teamId: "<id>",
    updateSupportHoursSchedule: {},
  });
...
```typescript
import { FirehydrantCore } from "firehydrant-typescript-sdk/core.js";
import { signalsUpdateSupportHoursSchedule } from "firehydrant-typescript-sdk/funcs/signalsUpdateSupportHoursSchedule.js";
...
async function run() {
  const res = await signalsUpdateSupportHoursSchedule(firehydrant, {
    teamId: "<id>",
    updateSupportHoursSchedule: {},
  });
  if (res.ok) {
    ...
    console.log("signalsUpdateSupportHoursSchedule failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.UpdateSupportHoursScheduleRequest](../../models/operations/updatesupporthoursschedulerequest.md)                                                                   | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
