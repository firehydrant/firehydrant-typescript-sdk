...
| `oidcAuthenticationConfigIssuerUrl`                            | *string*                                                       | :heavy_minus_sign:                                             | N/A                                                            |
| `oidcAuthenticationConfigClientId`                             | *string*                                                       | :heavy_minus_sign:                                             | N/A                                                            |
| `oidcAuthenticationConfigClientSecret`                         | *string*                                                       | :heavy_minus_sign:                                             | N/A                                                            |
| `autoPublish`                                                  | *boolean*                                                      | :heavy_minus_sign:                                             | N/A                                                            |
| `onlyDisplayActiveIncidents`                                   | *boolean*                                                      | :heavy_minus_sign:                                             | N/A                                                            |