...
export type ListNotificationPolicySettingsRequest = {
  page?: number | null | undefined;
  perPage?: number | null | undefined;
};

/** @internal */
export const ListNotificationPolicySettingsRequest$inboundSchema: z.ZodType<
...
/** @internal */
export const ListNotificationPolicySettingsRequest$outboundSchema: z.ZodType<
  ListNotificationPolicySettingsRequest$Outbound,
  z.ZodTypeDef,
  ListNotificationPolicySettingsRequest
> = z.object({
  page: z.nullable(z.number().int()).optional(),
...
export function listNotificationPolicySettingsRequestToJSON(
  ...
  return JSON.stringify(
    ListNotificationPolicySettingsRequest$outboundSchema.parse(
      listNotificationPolicySettingsRequest,
    ),
  );
}
...
export function listNotificationPolicySettingsRequestFromJSON(
  ...
  return safeParse(
    jsonString,
    (x) =>
      ListNotificationPolicySettingsRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ListNotificationPolicySettingsRequest' from JSON`,
  );
}
