...
/** @internal */
export const NullableTeamEntityLite$inboundSchema: z.ZodType<
...
/** @internal */
export const NullableTeamEntityLite$outboundSchema: z.ZodType<
...
export function nullableTeamEntityLiteFromJSON(
  ...
  return safeParse(
    jsonString,
    (x) => NullableTeamEntityLite$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'NullableTeamEntityLite' from JSON`,
  );
}
