 ...
 */
export type NullableSignalsAPIOnCallShiftEntity = {
...
/** @internal */
export const NullableSignalsAPIOnCallShiftEntity$inboundSchema: z.ZodType<
...
/** @internal */
export const NullableSignalsAPIOnCallShiftEntity$outboundSchema: z.ZodType<
...
export function nullableSignalsAPIOnCallShiftEntityToJSON(
  ...
  return JSON.stringify(
    NullableSignalsAPIOnCallShiftEntity$outboundSchema.parse(
      nullableSignalsAPIOnCallShiftEntity,
    ),
  );
}
...
export function nullableSignalsAPIOnCallShiftEntityFromJSON(
  ...
  return safeParse(
    jsonString,
    (x) =>
      NullableSignalsAPIOnCallShiftEntity$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'NullableSignalsAPIOnCallShiftEntity' from JSON`,
  );
}
