...
const args = {
  request: operations.UpdateIncidentImpactPatchRequest$inboundSchema,
};

export const tool$incidentsUpdateIncidentImpactPatch: ToolDefinition<
  typeof args
> = {
  name: "incidents-update-incident-impact-patch",
...
`,
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await incidentsUpdateIncidentImpactPatch(
      client,
      args.request,
