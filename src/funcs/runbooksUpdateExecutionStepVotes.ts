 ...
 */
export async function runbooksUpdateExecutionStepVotes(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateRunbookExecutionStepVotesRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON(
    "body",
    payload.patchV1RunbooksExecutionsExecutionIdStepsStepIdVotes,
    { explode: true },
  );
