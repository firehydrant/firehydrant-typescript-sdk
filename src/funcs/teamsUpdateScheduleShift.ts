 ...
 */
export async function teamsUpdateScheduleShift(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateTeamScheduleShiftRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload.patchV1TeamsTeamIdOnCallSchedulesScheduleIdShiftsId,
    { explode: true },
  );
