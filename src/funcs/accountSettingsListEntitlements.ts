 ...
 */
export async function accountSettingsListEntitlements(
  client: FirehydrantTypescriptSDKCore,
  request: operations.ListEntitlementsRequest,
  options?: RequestOptions,
): Promise<
  Result<
    components.EntitlementEntityPaginated,
    | errors.BadRequest
    | errors.Unauthorized
    | errors.NotFound
    | errors.Timeout
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.EntitlementEntityPaginated$inboundSchema),
    M.jsonErr(
