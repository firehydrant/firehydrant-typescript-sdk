 ...
 * List all reports
 */
export function retrospectivesListPostMortemReports(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListPostMortemReportsRequest$outboundSchema.parse(value),
  ...
  >(
    M.json(
      200,
      components.PostMortemsPostMortemReportEntityPaginated$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
