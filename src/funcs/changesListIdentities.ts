...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListChangeIdentitiesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.ChangeIdentityEntityPaginated$inboundSchema),
    M.jsonErr(
