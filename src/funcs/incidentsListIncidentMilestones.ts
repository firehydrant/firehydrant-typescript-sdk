 ...
 */
export function incidentsListIncidentMilestones(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListIncidentMilestonesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/incidents/{incident_id}/milestones")(pathParams);
