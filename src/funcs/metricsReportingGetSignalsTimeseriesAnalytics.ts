 ...
 */
export function metricsReportingGetSignalsTimeseriesAnalytics(
  client: FirehydrantCore,
  request: operations.GetSignalsTimeseriesAnalyticsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.SignalsAPIAnalyticsTimeseriesPointEntity,
    | FirehydrantError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetSignalsTimeseriesAnalyticsRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v1/signals/analytics/timeseries")();
  ...
  >(
    M.json(
      200,
      components.SignalsAPIAnalyticsTimeseriesPointEntity$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
