 ...
 */
export function conversationsUpdateComment(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateCommentRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.update_comment, { explode: true });
