 ...
 */
export async function conversationsUpdateComment(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateConversationCommentRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload.patchV1ConversationsConversationIdCommentsCommentId,
    { explode: true },
  );
