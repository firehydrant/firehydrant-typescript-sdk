 ...
 */
export function integrationsListAwsConnections(
  client: FirehydrantCore,
  request: operations.ListAwsConnectionsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.IntegrationsAwsConnectionEntityPaginated,
    | FirehydrantError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListAwsConnectionsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/integrations/aws/connections")();
  ...
  >(
    M.json(
      200,
      components.IntegrationsAwsConnectionEntityPaginated$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
