 ...
 */
export function catalogEntriesListFunctionalities(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListFunctionalitiesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.FunctionalityEntityPaginated$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response);
  if (!result.ok) {
