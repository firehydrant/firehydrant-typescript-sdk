...
> {
  ...
  const path = pathToFunc("/v1/schedules")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.ScheduleEntityPaginated$inboundSchema),
    M.jsonErr(
