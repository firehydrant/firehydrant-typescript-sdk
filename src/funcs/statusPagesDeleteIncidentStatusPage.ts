 ...
 */
export function statusPagesDeleteIncidentStatusPage(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteIncidentStatusPageRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    status_page_id: encodeSimple("status_page_id", payload.status_page_id, {
      explode: false,
      charEncoding: "percent",
    }),
  };
