 ...
 */
export function audiencesGetMemberDefaultAudience(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetMemberDefaultAudienceRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/audiences/member/{member_id}/default")(
    pathParams,
  );
