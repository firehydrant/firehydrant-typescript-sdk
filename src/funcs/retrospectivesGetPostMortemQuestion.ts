 ...
 */
export function retrospectivesGetPostMortemQuestion(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetPostMortemQuestionRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    question_id: encodeSimple("question_id", payload.question_id, {
      explode: false,
      charEncoding: "percent",
    }),
  };

  const path = pathToFunc("/v1/post_mortems/questions/{question_id}")(
    pathParams,
  );
