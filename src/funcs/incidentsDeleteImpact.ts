 ...
 */
export async function incidentsDeleteImpact(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteIncidentImpactRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/incidents/{incident_id}/impact/{type}/{id}")(
    pathParams,
  );
