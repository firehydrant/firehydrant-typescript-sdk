 ...
 */
export function signalsCreateSignalsHeartbeatEndpointConfiguration(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.CreateSignalsHeartbeatEndpointConfiguration$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/v1/signals/heartbeat_endpoints")();
