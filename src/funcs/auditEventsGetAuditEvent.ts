 ...
 * Get a single audit event
 */
export function auditEventsGetAuditEvent(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAuditEventRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/audit_events/{id}")(pathParams);
