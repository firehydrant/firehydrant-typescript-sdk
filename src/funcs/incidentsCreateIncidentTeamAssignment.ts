 ...
 */
export function incidentsCreateIncidentTeamAssignment(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateIncidentTeamAssignmentRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON("body", payload.create_incident_team_assignment, {
    explode: true,
  });
  ...
  const path = pathToFunc("/v1/incidents/{incident_id}/team_assignments")(
    pathParams,
  );
