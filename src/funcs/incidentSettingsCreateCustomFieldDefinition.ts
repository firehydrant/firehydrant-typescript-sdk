 ...
 */
export async function incidentSettingsCreateCustomFieldDefinition(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.PostV1CustomFieldsDefinitions$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/custom_fields/definitions")();
