 ...
 */
export function incidentSettingsUpdateLifecycleMeasurementDefinition(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateLifecycleMeasurementDefinitionRequest$outboundSchema
        .parse(value),
  ...
  const pathParams = {
    measurement_definition_id: encodeSimple(
