 ...
 */
export async function retrospectivesUpdateReportReasonOrder(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateRetrospectiveReportReasonOrderRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload.putV1PostMortemsReportsReportIdReasonsOrder,
    { explode: true },
  );
