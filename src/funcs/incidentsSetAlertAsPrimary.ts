 ...
 */
export async function incidentsSetAlertAsPrimary(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SetIncidentAlertAsPrimaryRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload.patchV1IncidentsIncidentIdAlertsIncidentAlertIdPrimary,
    { explode: true },
  );
