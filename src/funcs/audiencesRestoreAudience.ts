 ...
 */
export function audiencesRestoreAudience(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.RestoreAudienceRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/audiences/{audience_id}/restore")(pathParams);
