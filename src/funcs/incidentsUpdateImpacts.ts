 ...
 */
export async function incidentsUpdateImpacts(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateIncidentImpactsRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.putV1IncidentsIncidentIdImpact, {
    explode: true,
  });
