...
export function signalsListTeamOnCallSchedules(
  ...
  Result<
    components.SignalsAPIOnCallScheduleEntityPaginated,
    | FirehydrantError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListTeamOnCallSchedulesRequest$outboundSchema.parse(value),
  ...
  >(
    M.json(
      200,
      components.SignalsAPIOnCallScheduleEntityPaginated$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
