 ...
 */
export async function incidentSettingsValidateIncidentTags(
  client: FirehydrantTypescriptSDKCore,
  request: Array<string>,
  options?: RequestOptions,
): Promise<
  Result<
    components.TagEntity,
    | errors.BadRequest
    | errors.Unauthorized
    | errors.NotFound
    | errors.Timeout
...
> {
  ...
  const path = pathToFunc("/v1/incident_tags/validate")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.TagEntity$inboundSchema),
    M.jsonErr(
