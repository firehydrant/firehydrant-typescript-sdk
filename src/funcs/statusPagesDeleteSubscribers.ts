...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteStatusPageSubscribersRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.NuncEmailSubscribersEntity$inboundSchema),
    M.jsonErr(
