 ...
 */
export async function conversationsListComments(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListConversationCommentsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/conversations/{conversation_id}/comments")(
    pathParams,
  );
