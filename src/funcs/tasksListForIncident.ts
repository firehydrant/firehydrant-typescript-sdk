...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListIncidentTasksRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.TaskEntityPaginated$inboundSchema),
    M.jsonErr(
