 ...
 */
export async function incidentsListRelatedChangeEvents(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListIncidentRelatedChangesRequest$outboundSchema.parse(value),
  ...
  >(
    M.json(
      200,
      components.IncidentsRelatedChangeEventEntityPaginated$inboundSchema,
    ),
    M.jsonErr(
