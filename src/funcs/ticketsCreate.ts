...
> {
  const parsed = safeParse(
    request,
    (value) => components.PostV1TicketingTickets$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/ticketing/tickets")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.TicketingTicketEntity$inboundSchema),
    M.jsonErr(
