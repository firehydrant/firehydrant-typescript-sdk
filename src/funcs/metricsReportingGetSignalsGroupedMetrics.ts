 ...
 */
export function metricsReportingGetSignalsGroupedMetrics(
  client: FirehydrantCore,
  request: operations.GetSignalsGroupedMetricsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.SignalsAPIAnalyticsGroupedMetricsEntity,
    | FirehydrantError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetSignalsGroupedMetricsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/signals/analytics/grouped_metrics")();
  ...
  >(
    M.json(
      200,
      components.SignalsAPIAnalyticsGroupedMetricsEntity$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
