 ...
 */
export async function metricsReportingListIncidentMetrics(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListIncidentMetricsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/metrics/incidents")();
