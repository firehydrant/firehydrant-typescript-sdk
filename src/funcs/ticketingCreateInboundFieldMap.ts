 ...
 */
export function ticketingCreateInboundFieldMap(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateInboundFieldMapRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.TicketingProjectInboundFieldMapEntity$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response);
  if (!result.ok) {
