 ...
 */
export async function incidentsListImpact(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListIncidentImpactRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.IncidentImpactEntityPaginated$inboundSchema),
    M.jsonErr(
