 ...
 */
export function incidentSettingsAppendFormDataOnSelectedValueGet(
  client: FirehydrantCore,
  request: operations.AppendFormDataOnSelectedValueGetRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.PublicApiv1FormConfigurationsSelectedValueEntity,
    | FirehydrantError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AppendFormDataOnSelectedValueGetRequest$outboundSchema.parse(
        value,
      ),
  ...
  const pathParams = {
    ...
    selected_value: encodeSimple("selected_value", payload.selected_value, {
      explode: false,
      charEncoding: "percent",
    }),
  ...
  >(
    M.json(
      200,
      components.PublicApiv1FormConfigurationsSelectedValueEntity$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
