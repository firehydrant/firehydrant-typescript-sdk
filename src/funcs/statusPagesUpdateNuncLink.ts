 ...
 */
export function statusPagesUpdateNuncLink(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateNuncLinkRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.update_nunc_link, { explode: true });
