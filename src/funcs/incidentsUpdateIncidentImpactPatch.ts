 ...
 */
export function incidentsUpdateIncidentImpactPatch(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateIncidentImpactPatchRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.update_incident_impact_patch, {
    explode: true,
  });
