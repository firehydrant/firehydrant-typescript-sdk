...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteNuncSubscriptionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/nunc/subscriptions/{unsubscribe_token}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.NuncNuncSubscription$inboundSchema),
    M.jsonErr(
