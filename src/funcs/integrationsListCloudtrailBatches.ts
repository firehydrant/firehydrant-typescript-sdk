 ...
 */
export async function integrationsListCloudtrailBatches(
  client: FirehydrantTypescriptSDKCore,
  request: operations.ListAwsCloudtrailBatchesRequest,
  options?: RequestOptions,
): Promise<
  Result<
    components.IntegrationsAwsCloudtrailBatchEntityPaginated,
    | errors.BadRequest
    | errors.Unauthorized
    | errors.NotFound
    | errors.Timeout
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListAwsCloudtrailBatchesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/integrations/aws/cloudtrail_batches")();
  ...
  >(
    M.json(
      200,
      components.IntegrationsAwsCloudtrailBatchEntityPaginated$inboundSchema,
    ),
    M.jsonErr(
