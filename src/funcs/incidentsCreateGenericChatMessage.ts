 ...
 */
export async function incidentsCreateGenericChatMessage(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateIncidentGenericChatMessageRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON(
    "body",
    payload.postV1IncidentsIncidentIdGenericChatMessages,
    { explode: true },
  );
