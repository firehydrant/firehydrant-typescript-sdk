 ...
 * Lists priorities
 */
export async function incidentSettingsListPriorities(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListPrioritiesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/priorities")();
