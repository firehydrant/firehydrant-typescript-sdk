 ...
 */
export function signalsPreviewOnCallScheduleRotation(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PreviewOnCallScheduleRotationRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON("body", payload.preview_on_call_schedule_rotation, {
    explode: true,
  });
  ...
  const path = pathToFunc(
    "/v1/teams/{team_id}/on_call_schedules/{schedule_id}/rotations/preview",
  )(pathParams);
