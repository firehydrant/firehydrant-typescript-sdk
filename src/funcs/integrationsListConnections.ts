 ...
 */
export function integrationsListConnections(
  client: FirehydrantCore,
  request: operations.ListConnectionsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.IntegrationsConnectionEntityPaginated,
    | FirehydrantError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.IntegrationsConnectionEntityPaginated$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
