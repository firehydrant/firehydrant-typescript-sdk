 ...
 */
export function integrationsSearchSlackChannels(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SearchSlackChannelsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/integrations/slack/channels")();
