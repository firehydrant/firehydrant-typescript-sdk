 ...
 */
export async function integrationsStatuspageListConnections(
  client: FirehydrantTypescriptSDKCore,
  request: operations.ListStatuspageConnectionsRequest,
  options?: RequestOptions,
): Promise<
  Result<
    components.IntegrationsStatuspageConnectionEntityPaginated,
    | errors.BadRequest
    | errors.Unauthorized
    | errors.NotFound
    | errors.Timeout
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListStatuspageConnectionsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/integrations/statuspage/connections")();
  ...
  >(
    M.json(
      200,
      components.IntegrationsStatuspageConnectionEntityPaginated$inboundSchema,
    ),
    M.jsonErr(
