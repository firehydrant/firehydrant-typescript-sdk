 ...
 */
export async function incidentsCreateRelatedChange(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateIncidentRelatedChangeRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload.postV1IncidentsIncidentIdRelatedChangeEvents,
    { explode: true },
  );
