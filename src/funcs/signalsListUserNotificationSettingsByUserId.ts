 ...
 */
export function signalsListUserNotificationSettingsByUserId(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListUserNotificationSettingsByUserIdRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/v1/signals/users/{user_id}/notification_settings")(
    pathParams,
  );
  ...
  >(
    M.json(
      200,
      components.SignalsAPIUserNotificationSettingEntityPaginated$inboundSchema,
    ),
    M.jsonErr(403, errors.ErrorEntity$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
