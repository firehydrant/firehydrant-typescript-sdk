 ...
 */
export function retrospectivesCreateIncidentRetrospectiveDynamicInput(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateIncidentRetrospectiveDynamicInputRequest$outboundSchema
        .parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, components.IncidentsRetrospectiveFieldEntity$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
