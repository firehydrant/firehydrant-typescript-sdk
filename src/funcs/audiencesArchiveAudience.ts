 ...
 * Archive an audience
 */
export function audiencesArchiveAudience(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ArchiveAudienceRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/audiences/{audience_id}")(pathParams);
