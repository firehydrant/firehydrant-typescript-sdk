 ...
 * Update the attribution of a transcript
 */
export function incidentsUpdateTranscriptAttribution(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateTranscriptAttributionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/incidents/{incident_id}/transcript/attribution")(
    pathParams,
  );
