 ...
 */
export async function retrospectivesPublishReport(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PublishRetrospectiveReportRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload.postV1PostMortemsReportsReportIdPublish,
    { explode: true },
  );
