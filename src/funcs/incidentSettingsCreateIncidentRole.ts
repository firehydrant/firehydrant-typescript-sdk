 ...
 */
export async function incidentSettingsCreateIncidentRole(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.PostV1IncidentRoles$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.IncidentRoleEntity$inboundSchema),
    M.jsonErr(
