 ...
 */
export function retrospectivesListPostMortemQuestions(
  client: FirehydrantCore,
  request: operations.ListPostMortemQuestionsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.PostMortemsQuestionTypeEntityPaginated,
    | FirehydrantError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListPostMortemQuestionsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/post_mortems/questions")();
  ...
  >(
    M.json(
      200,
      components.PostMortemsQuestionTypeEntityPaginated$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
