 ...
 */
export async function teamsCreateShift(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateTeamOnCallScheduleShiftRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON(
    "body",
    payload.postV1TeamsTeamIdOnCallSchedulesScheduleIdShifts,
    { explode: true },
  );
