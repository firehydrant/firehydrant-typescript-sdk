 ...
 * Debug Signals expressions
 */
export function signalsDebugSignalsExpression(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.DebugSignalsExpression$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/signals/debugger")();
