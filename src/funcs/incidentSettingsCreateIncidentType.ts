 ...
 */
export async function incidentSettingsCreateIncidentType(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.PostV1IncidentTypes$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.IncidentTypeEntity$inboundSchema),
    M.jsonErr(
