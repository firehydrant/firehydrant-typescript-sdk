 ...
 */
export async function statusPagesCreateSubscription(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.PostV1NuncSubscriptions$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/nunc/subscriptions")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.NuncNuncSubscription$inboundSchema),
    M.jsonErr(
