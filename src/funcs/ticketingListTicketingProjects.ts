 ...
 */
export function ticketingListTicketingProjects(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListTicketingProjectsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/ticketing/projects")();

  const query = encodeFormQuery({
    "configured_projects": payload.configured_projects,
    "connection_ids": payload.connection_ids,
    "page": payload.page,
    "per_page": payload.per_page,
    "providers": payload.providers,
    "query": payload.query,
    "supports_ticket_types": payload.supports_ticket_types,
  });
  ...
  >(
    M.json(
      200,
      components.TicketingProjectsProjectListItemEntity$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
