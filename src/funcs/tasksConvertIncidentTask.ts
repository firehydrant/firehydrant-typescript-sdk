 ...
 * Convert a task to a follow-up
 */
export function tasksConvertIncidentTask(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ConvertIncidentTaskRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.convert_incident_task, {
    explode: true,
  });
