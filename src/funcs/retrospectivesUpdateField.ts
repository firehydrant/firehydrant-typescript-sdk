 ...
 */
export async function retrospectivesUpdateField(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateRetrospectiveFieldRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload.patchV1PostMortemsReportsReportIdFieldsFieldId,
    { explode: true },
  );
