 ...
 */
export async function runbooksCreateExecution(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.PostV1RunbooksExecutions$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.RunbooksExecutionEntity$inboundSchema),
    M.jsonErr(
