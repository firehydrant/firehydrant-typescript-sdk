 ...
 */
export function metricsReportingExportSignalsShiftAnalytics(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ExportSignalsShiftAnalyticsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/signals/analytics/shifts/export")();
