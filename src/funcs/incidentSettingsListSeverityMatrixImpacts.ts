 ...
 * Lists impacts
 */
export async function incidentSettingsListSeverityMatrixImpacts(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListSeverityMatrixImpactsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/severity_matrix/impacts")();
