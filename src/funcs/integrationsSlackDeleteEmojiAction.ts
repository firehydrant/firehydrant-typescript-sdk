 ...
 */
export async function integrationsSlackDeleteEmojiAction(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteSlackEmojiActionRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    emoji_action_id: encodeSimple("emoji_action_id", payload.emoji_action_id, {
      explode: false,
      charEncoding: "percent",
    }),
  };
