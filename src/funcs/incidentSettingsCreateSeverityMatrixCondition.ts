 ...
 */
export async function incidentSettingsCreateSeverityMatrixCondition(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.PostV1SeverityMatrixConditions$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/severity_matrix/conditions")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.SeverityMatrixConditionEntity$inboundSchema),
    M.jsonErr(
