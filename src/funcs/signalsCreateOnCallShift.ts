 ...
 */
export function signalsCreateOnCallShift(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateOnCallShiftRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.create_on_call_shift, {
    explode: true,
  });
