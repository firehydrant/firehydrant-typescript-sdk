 ...
 */
export function ticketingListAvailableInboundFieldMaps(
  client: FirehydrantCore,
  request: operations.ListAvailableInboundFieldMapsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.TicketingProjectInboundMappableFieldEntity,
    | FirehydrantError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListAvailableInboundFieldMapsRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      components.TicketingProjectInboundMappableFieldEntity$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
