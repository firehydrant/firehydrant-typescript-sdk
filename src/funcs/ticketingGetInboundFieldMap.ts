 ...
 */
export function ticketingGetInboundFieldMap(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetInboundFieldMapRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.TicketingProjectInboundFieldMapEntity$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
