 ...
 * Lists the available and configured integrations
 */
export function integrationsListAuthedProviders(
  client: FirehydrantCore,
  request: operations.ListAuthedProvidersRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.IntegrationsAuthedProviderEntityPaginated,
    | FirehydrantError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListAuthedProvidersRequest$outboundSchema.parse(value),
  ...
  >(
    M.json(
      200,
      components.IntegrationsAuthedProviderEntityPaginated$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
