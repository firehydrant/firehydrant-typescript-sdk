 ...
 */
export async function incidentsGetUserRole(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetIncidentUserRoleRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/incidents/{incident_id}/users/{user_id}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.IncidentsRoleAssignmentEntity$inboundSchema),
    M.jsonErr(
