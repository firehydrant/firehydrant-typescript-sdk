 ...
 */
export async function incidentsUpdateMilestonesBulk(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateIncidentMilestonesBulkRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON(
    "body",
    payload.putV1IncidentsIncidentIdMilestonesBulkUpdate,
    { explode: true },
  );
