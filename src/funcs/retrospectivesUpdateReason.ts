 ...
 */
export async function retrospectivesUpdateReason(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateRetrospectiveReasonRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload.patchV1PostMortemsReportsReportIdReasonsReasonId,
    { explode: true },
  );
