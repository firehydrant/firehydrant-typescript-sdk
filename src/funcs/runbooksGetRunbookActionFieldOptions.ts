 ...
 * List select options for a runbook integration action field
 */
export function runbooksGetRunbookActionFieldOptions(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetRunbookActionFieldOptionsRequest$outboundSchema.parse(
        value,
      ),
  ...
  const pathParams = {
    action_slug: encodeSimple("action_slug", payload.action_slug, {
      explode: false,
