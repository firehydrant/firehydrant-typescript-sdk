 ...
 * List attachments for an incident
 */
export function incidentsListIncidentAttachments(
  client: FirehydrantCore,
  request: operations.ListIncidentAttachmentsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.AttachmentsTypedAttachmentEntityPaginated,
    | FirehydrantError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListIncidentAttachmentsRequest$outboundSchema.parse(value),
  ...
  >(
    M.json(
      200,
      components.AttachmentsTypedAttachmentEntityPaginated$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
