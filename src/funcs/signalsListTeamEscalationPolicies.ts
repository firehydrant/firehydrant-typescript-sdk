 ...
 */
export function signalsListTeamEscalationPolicies(
  client: FirehydrantCore,
  request: operations.ListTeamEscalationPoliciesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.SignalsAPIEscalationPolicyEntityPaginated,
    | FirehydrantError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListTeamEscalationPoliciesRequest$outboundSchema.parse(value),
  ...
  >(
    M.json(
      200,
      components.SignalsAPIEscalationPolicyEntityPaginated$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
