 ...
 */
export async function metricsReportingListInfrastructureMetrics(
...
> {
  ...
  const path = pathToFunc("/v1/metrics/{infra_type}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.MetricsInfrastructureListEntity$inboundSchema),
    M.jsonErr(
