 ...
 */
export function incidentsDeleteIncidentRoleAssignment(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteIncidentRoleAssignmentRequest$outboundSchema.parse(
        value,
      ),
  ...
  const pathParams = {
    ...
    role_assignment_id: encodeSimple(
      "role_assignment_id",
