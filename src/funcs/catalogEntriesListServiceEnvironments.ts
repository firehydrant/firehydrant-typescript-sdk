 ...
 * List environments for a service
 */
export function catalogEntriesListServiceEnvironments(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListServiceEnvironmentsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/services/{service_id}/environments")(pathParams);
