 ...
 */
export async function integrationsTicketingGetProject(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetTicketingProjectRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/ticketing/projects/{ticketing_project_id}")(
    pathParams,
  );
