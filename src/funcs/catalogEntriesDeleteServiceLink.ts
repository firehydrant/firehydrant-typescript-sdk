 ...
 */
export function catalogEntriesDeleteServiceLink(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteServiceLinkRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    remote_id: encodeSimple("remote_id", payload.remote_id, {
      explode: false,
