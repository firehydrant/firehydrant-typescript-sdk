 ...
 */
export function incidentsCreateIncidentAttachment(
...
> {
  ...
  if (payload.RequestBody.occurred_at !== undefined) {
    appendForm(body, "occurred_at", payload.RequestBody.occurred_at);
  }
  if (payload.RequestBody.vote_direction !== undefined) {
    appendForm(body, "vote_direction", payload.RequestBody.vote_direction);
  }
