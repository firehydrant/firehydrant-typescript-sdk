 ...
 */
export function incidentsListIncidentRoleAssignments(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListIncidentRoleAssignmentsRequest$outboundSchema.parse(value),
  ...
  >(
    M.json(
      200,
      components.IncidentsRoleAssignmentEntityPaginated$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
