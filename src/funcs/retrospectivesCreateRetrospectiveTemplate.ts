 ...
 */
export function retrospectivesCreateRetrospectiveTemplate(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateRetrospectiveTemplateRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.RetrospectivesTemplateEntity$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response);
  if (!result.ok) {
