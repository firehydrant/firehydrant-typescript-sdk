 ...
 */
export function scimUpdateSCIMUser(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateScimUserRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.update_scim_user, { explode: true });
  ...
  const path = pathToFunc("/v1/scim/v2/Users/{id}")(pathParams);
