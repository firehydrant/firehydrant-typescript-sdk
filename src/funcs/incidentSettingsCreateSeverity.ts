 ...
 */
export async function incidentSettingsCreateSeverity(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.PostV1Severities$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.SeverityEntity$inboundSchema),
    M.jsonErr(
