 ...
 */
export async function incidentSettingsListIncidentTags(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListIncidentTagsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/incident_tags")();
