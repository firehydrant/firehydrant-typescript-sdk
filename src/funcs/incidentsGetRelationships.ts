...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetIncidentRelationshipsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/incidents/{incident_id}/relationships")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.IncidentsRelationshipsEntity$inboundSchema),
    M.jsonErr(
