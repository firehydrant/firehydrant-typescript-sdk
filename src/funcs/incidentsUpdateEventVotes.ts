 ...
 */
export async function incidentsUpdateEventVotes(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateIncidentEventVotesRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload.patchV1IncidentsIncidentIdEventsEventIdVotes,
    { explode: true },
  );
