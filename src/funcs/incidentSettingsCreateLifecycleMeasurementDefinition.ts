 ...
 */
export function incidentSettingsCreateLifecycleMeasurementDefinition(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateLifecycleMeasurementDefinitionRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/v1/lifecycles/measurement_definitions")();
