 ...
 */
export async function signalsUpdateEmailTarget(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateSignalEmailTargetRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.patchV1SignalsEmailTargetsId, {
    explode: true,
  });
