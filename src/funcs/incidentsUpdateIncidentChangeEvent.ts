 ...
 * Update a change attached to an incident
 */
export function incidentsUpdateIncidentChangeEvent(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateIncidentChangeEventRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.update_incident_change_event, {
    explode: true,
  });
