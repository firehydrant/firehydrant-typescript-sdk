 ...
 */
export async function incidentsCreateAttachment(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateIncidentAttachmentRequest$outboundSchema.parse(value),
  ...
  if (payload.RequestBody.description !== undefined) {
    body.append("description", payload.RequestBody.description);
  }
  if (payload.RequestBody.occurred_at !== undefined) {
    body.append("occurred_at", payload.RequestBody.occurred_at);
  }
  if (payload.RequestBody.vote_direction !== undefined) {
    body.append("vote_direction", payload.RequestBody.vote_direction);
  }
