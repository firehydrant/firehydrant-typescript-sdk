 ...
 * Search for Zendesk tickets
 */
export function integrationsSearchZendeskTickets(
  client: FirehydrantCore,
  request: operations.SearchZendeskTicketsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.IntegrationsZendeskSearchTicketsPaginatedEntity,
    | FirehydrantError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SearchZendeskTicketsRequest$outboundSchema.parse(value),
  ...
  >(
    M.json(
      200,
      components.IntegrationsZendeskSearchTicketsPaginatedEntity$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
