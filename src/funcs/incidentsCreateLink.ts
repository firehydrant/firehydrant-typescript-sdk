...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateIncidentLinkRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.postV1IncidentsIncidentIdLinks, {
    explode: true,
  });
  ...
  const path = pathToFunc("/v1/incidents/{incident_id}/links")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.AttachmentsLinkEntity$inboundSchema),
    M.jsonErr(
