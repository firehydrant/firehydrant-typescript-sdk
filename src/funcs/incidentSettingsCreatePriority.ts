 ...
 */
export async function incidentSettingsCreatePriority(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.PostV1Priorities$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.PriorityEntity$inboundSchema),
    M.jsonErr(
