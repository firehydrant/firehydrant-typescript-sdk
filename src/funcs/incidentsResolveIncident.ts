 ...
 */
export function incidentsResolveIncident(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ResolveIncidentRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/incidents/{incident_id}/resolve")(pathParams);
