 ...
 * Delete a milestone
 */
export async function incidentSettingsDeleteLifecycleMilestone(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteLifecycleMilestoneRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    milestone_id: encodeSimple("milestone_id", payload.milestone_id, {
      explode: false,
      charEncoding: "percent",
    }),
  };

  const path = pathToFunc("/v1/lifecycles/milestones/{milestone_id}")(
    pathParams,
  );
