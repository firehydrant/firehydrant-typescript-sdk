...
export async function ticketsUpdate(
  ...
  Result<
    components.TicketingTicketEntity,
    | errors.BadRequest
    | errors.Unauthorized
    | errors.NotFound
    | errors.Timeout
...
> {
  ...
  const body = encodeJSON("body", payload.patchV1TicketingTicketsTicketId, {
    explode: true,
  });
  ...
  const path = pathToFunc("/v1/ticketing/tickets/{ticket_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.TicketingTicketEntity$inboundSchema),
    M.jsonErr(
