 ...
 */
export function metricsReportingListRetrospectiveMetrics(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListRetrospectiveMetricsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/metrics/retrospectives")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.MetricsRetrospectiveEntity$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
