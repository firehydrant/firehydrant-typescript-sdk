 ...
 */
export function incidentsCloseIncident(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CloseIncidentRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/incidents/{incident_id}/close")(pathParams);
