 ...
 */
export function integrationsTestSlackChannel(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.TestSlackChannelRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/integrations/slack/channels/{id}/test")(
    pathParams,
  );
