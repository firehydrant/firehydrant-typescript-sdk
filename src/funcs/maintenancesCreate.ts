 ...
 */
export async function maintenancesCreate(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.PostV1ScheduledMaintenances$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/scheduled_maintenances")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.ScheduledMaintenanceEntity$inboundSchema),
