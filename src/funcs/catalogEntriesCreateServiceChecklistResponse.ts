 ...
 */
export function catalogEntriesCreateServiceChecklistResponse(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateServiceChecklistResponseRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON("body", payload.create_service_checklist_response, {
    explode: true,
  });

  const pathParams = {
    checklist_id: encodeSimple("checklist_id", payload.checklist_id, {
      explode: false,
