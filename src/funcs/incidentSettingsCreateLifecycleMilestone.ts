 ...
 */
export function incidentSettingsCreateLifecycleMilestone(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateLifecycleMilestoneRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/lifecycles/milestones")();
