 ...
 */
export async function signalsGetIngestUrl(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetSignalIngestUrlRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/signals/ingest_url")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.SignalsAPIIngestKeyEntity$inboundSchema),
    M.jsonErr(
