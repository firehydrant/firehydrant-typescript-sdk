 ...
 */
export async function usersGetCurrent(
  client: FirehydrantTypescriptSDKCore,
  options?: RequestOptions,
): Promise<
  Result<
    components.CurrentUserEntity,
    | errors.BadRequest
    | errors.Unauthorized
    | errors.NotFound
    | errors.Timeout
  ...
  >
> {
  const path = pathToFunc("/v1/current_user")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.CurrentUserEntity$inboundSchema),
    M.jsonErr(
