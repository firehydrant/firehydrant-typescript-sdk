 ...
 */
export function retrospectivesExportIncidentRetrospectives(
  client: FirehydrantCore,
  request: operations.ExportIncidentRetrospectivesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.IncidentsExportRetrospectivesResultEntity,
    | FirehydrantError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ExportIncidentRetrospectivesRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v1/incidents/{incident_id}/retrospectives/export")(
    pathParams,
  );
  ...
  >(
    M.json(
      201,
      components.IncidentsExportRetrospectivesResultEntity$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
