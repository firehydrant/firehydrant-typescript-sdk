 ...
 */
export async function statusPagesUpdateLink(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateStatusPageLinkRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload.patchV1NuncConnectionsNuncConnectionIdLinksLinkId,
    { explode: true },
  );
