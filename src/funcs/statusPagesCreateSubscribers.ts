 ...
 */
export async function statusPagesCreateSubscribers(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateStatusPageSubscribersRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.NuncEmailSubscribersEntity$inboundSchema),
    M.jsonErr(
