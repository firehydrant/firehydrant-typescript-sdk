 ...
 */
export function signalsCreateOnCallScheduleRotation(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateOnCallScheduleRotationRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON("body", payload.create_on_call_schedule_rotation, {
    explode: true,
  });
