 ...
 */
export async function integrationsCreateFieldMap(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateTicketingProjectFieldMapRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.TicketingProjectFieldMapEntity$inboundSchema),
    M.jsonErr(
