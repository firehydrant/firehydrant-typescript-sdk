 ...
 */
export async function incidentSettingsCreateTicketingPriority(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.PostV1TicketingPriorities$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/ticketing/priorities")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.TicketingPriorityEntity$inboundSchema),
    M.jsonErr(
