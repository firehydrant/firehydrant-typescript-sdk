...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListAudienceSummariesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/audiences/summaries/{incident_id}")(pathParams);
  ...
  >(
    M.json(
      200,
      components.AudiencesEntitiesAudienceSummariesEntity$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response);
