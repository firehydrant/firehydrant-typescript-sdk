 ...
 */
export async function servicesCatalogsRefresh(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.RefreshCatalogRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/catalogs/{catalog_id}/refresh")(pathParams);
