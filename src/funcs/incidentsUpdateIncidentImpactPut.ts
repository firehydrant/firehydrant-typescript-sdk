 ...
 */
export function incidentsUpdateIncidentImpactPut(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateIncidentImpactPutRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.update_incident_impact_put, {
    explode: true,
  });
