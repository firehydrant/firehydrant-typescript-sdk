 ...
 */
export function scimPatchSCIMGroup(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PatchScimGroupRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.patch_scim_group, { explode: true });
  ...
  const path = pathToFunc("/v1/scim/v2/Groups/{id}")(pathParams);
