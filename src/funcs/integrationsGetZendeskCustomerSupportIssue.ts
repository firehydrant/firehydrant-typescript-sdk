 ...
 * Search for Zendesk tickets
 */
export function integrationsGetZendeskCustomerSupportIssue(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetZendeskCustomerSupportIssueRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v1/integrations/zendesk/search")();
