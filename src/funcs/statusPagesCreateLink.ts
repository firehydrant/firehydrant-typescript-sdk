 ...
 */
export async function statusPagesCreateLink(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateStatusPageLinkRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/nunc_connections/{nunc_connection_id}/links")(
    pathParams,
  );
