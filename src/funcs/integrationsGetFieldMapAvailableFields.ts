 ...
 */
export async function integrationsGetFieldMapAvailableFields(
  client: FirehydrantTypescriptSDKCore,
  request: operations.GetIntegrationFieldMapAvailableFieldsRequest,
  options?: RequestOptions,
): Promise<
  Result<
    components.FieldMappingMappableFieldEntity,
    | errors.BadRequest
    | errors.Unauthorized
    | errors.NotFound
    | errors.Timeout
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetIntegrationFieldMapAvailableFieldsRequest$outboundSchema
        .parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.FieldMappingMappableFieldEntity$inboundSchema),
    M.jsonErr(
