 ...
 */
export async function incidentSettingsListLifecyclePhases(
  ...
  >
> {
  const path = pathToFunc("/v1/lifecycles/phases")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.LifecyclesPhaseEntityList$inboundSchema),
    M.jsonErr(
