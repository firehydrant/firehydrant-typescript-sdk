 ...
 */
export function scimPatchSCIMUser(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PatchScimUserRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.patch_scim_user, { explode: true });
