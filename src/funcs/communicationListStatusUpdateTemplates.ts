 ...
 */
export function communicationListStatusUpdateTemplates(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListStatusUpdateTemplatesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/status_update_templates")();
