 ...
 */
export function signalsListOrganizationOnCallSchedules(
  client: FirehydrantCore,
  request: operations.ListOrganizationOnCallSchedulesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.SignalsAPIOrganizationOnCallScheduleEntityPaginated,
    | FirehydrantError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListOrganizationOnCallSchedulesRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v1/signals_on_call")();
