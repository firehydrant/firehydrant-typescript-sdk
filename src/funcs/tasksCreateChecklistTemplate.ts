 ...
 */
export async function tasksCreateChecklistTemplate(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.PostV1ChecklistTemplates$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/checklist_templates")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.ChecklistTemplateEntity$inboundSchema),
